...
ssh root@roleplaycardgame.com "pkill -f 'card.py'"
...
ssh root@roleplaycardgame.com "cd RoleplayCardGame; source ./venv/bin/activate; nohup python card.py > output.txt &"
